...
class I2C_Device {
 public:
	...
	template<typename T, typename enable_if<!is_integral<remove_reference<T>>::value>::type>
	...
	template<typename T>
    static void raw_read(T&& arv, typename I2C::Acknowledge last_byte_ACK = I2C::NACK) {
