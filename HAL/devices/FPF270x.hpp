...
class FPF270x {
 public:
    constexpr FPF270x(const DigitalIO::Pin pin_on, const DigitalIO::Pin pin_flag, const DigitalIO::Pin pin_pgood) : DIO_on(pin_on), DIO_flag(pin_flag), DIO_pgood(pin_pgood) {
    }
