...
ifeq ($(BOARD),ATMEGA324P)
	MCU = ATMEGA324P_TQFP32
	F_CPU = 8000000L
	CFLAGS += -DBOARD_ATMEGA324P
	BOARD_FOLDER = $(HAL_PATH)/boards/ATMEGA324P
endif
...
ifeq ($(MCU),ATMEGA324P_TQFP32)
	CFLAGS += -DMCU_ATMEGA324P_TQFP32
