...
void SPI_t::init(SPI_t::InitTypeDef_t InitStruct) {
    pin_mosi.init({SPIPin_Descr.pin_mosi, GPIOPin_t::output});
    pin_miso.init({SPIPin_Descr.pin_miso, GPIOPin_t::input});
    pin_sck.init({SPIPin_Descr.pin_sck, GPIOPin_t::output});
