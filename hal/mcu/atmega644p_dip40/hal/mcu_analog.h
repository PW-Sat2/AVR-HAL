#ifndef HAL_MCU_ATMEGA644P_DIP40_HAL_MCU_ANALOG_H_
#define HAL_MCU_ATMEGA644P_DIP40_HAL_MCU_ANALOG_H_
 ...
 public:
    ...
    static void disable_digital() {
        static_assert(input <= Input::ADC7,
                      "Disabling digital buffer allowed only on ADC0..7");
...
#endif  // HAL_MCU_ATMEGA644P_DIP40_HAL_MCU_ANALOG_H_
