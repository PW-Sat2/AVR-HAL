#ifndef HAL_MCU_ATMEGA328P_TQFP32_HAL_MCU_ANALOG_H_
#define HAL_MCU_ATMEGA328P_TQFP32_HAL_MCU_ANALOG_H_
...
class InternalADCMcuSpecific {
 public:
    ...
    static void disable_digital() {
        static_assert(input < Input::ADC6,
                      "Disabling digital buffer allowed only on ADC0..8");
...
#endif  // HAL_MCU_ATMEGA328P_TQFP32_HAL_MCU_ANALOG_H_
